...
public class HorizontalCalendarView extends RecyclerView {
    ...
    public HorizontalCalendarView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            defaultStyle = new CalendarItemStyle(colorTopText, colorMiddleText, colorBottomText,
                    Typeface.DEFAULT, Typeface.DEFAULT, Typeface.DEFAULT, null);
            selectedItemStyle = new CalendarItemStyle(colorTopTextSelected, colorMiddleTextSelected, colorBottomTextSelected,
                    Typeface.DEFAULT, Typeface.DEFAULT, Typeface.DEFAULT, selectedDateBackground);
