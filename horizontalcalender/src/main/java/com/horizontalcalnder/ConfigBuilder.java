...
public class ConfigBuilder {
    ...
    public ConfigBuilder textStyle(Typeface fontTopText, Typeface fontMiddleText,
                                   Typeface fontBottomText) {
    ...
    CalendarItemStyle createDefaultStyle() {
        return new CalendarItemStyle(colorTextTop, colorTextMiddle, colorTextBottom, fontTopText, fontMiddleText, fontBottomText, null);
    }

    CalendarItemStyle createSelectedItemStyle() {
        return new CalendarItemStyle(colorTextTopSelected, colorTextMiddleSelected, colorTextBottomSelected,
                fontTopText, fontMiddleText, fontBottomText, selectedItemBackground);
    }
}
